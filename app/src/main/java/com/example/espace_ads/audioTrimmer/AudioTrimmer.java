...
import com.example.espace_ads.audioTrimmer.customAudioViews.MarkerView;
import com.example.espace_ads.audioTrimmer.customAudioViews.SamplePlayer;
import com.example.espace_ads.audioTrimmer.customAudioViews.SoundFile;
import com.example.espace_ads.audioTrimmer.customAudioViews.WaveformView;
import com.example.espace_ads.audioTrimmer.utils.Utility;

import java.io.File;
import java.io.RandomAccessFile;
import java.util.Locale;

public class AudioTrimmer extends AppCompatActivity implements View.OnClickListener,
...
//            txtAudioCrop.setBackgroundResource(R.drawable.ic_crop_btn);
            ...
            if (difference <= 0) {
                Toast.makeText(AudioTrimmer.this, "Trim seconds should be greater than 0 seconds", Toast.LENGTH_SHORT).show();
            } else if (difference > 60) {
                Toast.makeText(AudioTrimmer.this, "Trim seconds should be less than 1 minute", Toast.LENGTH_SHORT).show();
            } else {
                if (mIsPlaying) {
                    handlePause();
                }
